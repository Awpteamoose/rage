...
(function( root, factory ) {
    ...
    return (function( module_factory ) {
        ...
        if( typeof window === "undefined" && typeof process === "object" ) {
            ...
            var wasm_path = path.join( __dirname, "game-of-life.wasm" );
            var buffer = fs.readFileSync( wasm_path );
            var mod = new WebAssembly.Module( buffer );
            var wasm_instance = new WebAssembly.Instance( mod, instance.imports );
            return instance.initialize( wasm_instance );
        } else {
            var file = fetch( "game-of-life.wasm", {credentials: "same-origin"} );
            ...
            return wasm_instance
                .then( function( wasm_instance ) {
                    ...
                    console.log( "Finished loading Rust wasm module 'game_of_life'" );
                    return exports;
                })
                .catch( function( error ) {
                    console.log( "Error loading Rust wasm module 'game_of_life':", error );
                    throw error;
                });
        }
    }( function() {
...
Module.STDWEB_PRIVATE.acquire_tmp = function( dummy ) {
    ...
    return {
        imports: {
            ...
            "__extjs_134879fff6d540d3751a610b542c75dcc5f766ee": function($0, $1) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);Module.STDWEB_PRIVATE.from_js($0, (function(){return ($1). composedPath (). reduce ((acc , node)=> {const id = node.__rage_event_callback ; if (id)acc.push (id); return acc ;}, []);})());
            },
            ...
            "__extjs_cbd9ab50e213a9a554b2ca9ed651f4cec9549baa": function($0) {
            ...
            "__extjs_658b79049d5dd366bf7b5d2caaec7841e5b84730": function($0, $1, $2, $3) {
            ...
            "__extjs_a1e5288af3ad77d10a84f182d69f1d805acf7554": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). checked = ($2)})());
            },
            ...
            "__extjs_cb20e8724bc29995106161038625ff5e99842f46": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). __rage_event_callback = ($2)})());
            },
            ...
            "__extjs_957bbddd2bec6c5f894938b979180d6f7add20cc": function($0, $1, $2) {
                $1 = Module.STDWEB_PRIVATE.to_js($1);$2 = Module.STDWEB_PRIVATE.to_js($2);Module.STDWEB_PRIVATE.from_js($0, (function(){($1). value = ($2)})());
            },
